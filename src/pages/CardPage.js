...
export default function HomePage() {
    let [name,changeName] = useState('John Doe');
    let [cardnum, changeCardnum] = useState('0123 4567 8910 1112')
    ...
    return (
                    ...
                    <svg version="1.1" id="cardfront" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 750 471" style={{"enableBackground": "new 0 0 750 471"}} xmlSpace="preserve">
                        <g id="Front">
                            <g id="CardBackground">
                                ...
                                <path className="darkcolor reddark" d="M750,431V193.2c-217.6-57.5-556.4-13.5-750,24.9V431c0,22.1,17.9,40,40,40h670C732.1,471,750,453.1,750,431z" />
                            </g>
                            <text transform="matrix(1 0 0 1 60.106 295.0121)" id="svgnumber" className="st2 st3 st4">{cardnum}</text>
                ...
                <div className="back">
                    <svg version="1.1" id="cardback" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                        ...
                        <g id="Back">
                            <g id="Page-1_2_">
                                <g id="amex_2_">
                                    <path id="Rectangle-1_2_" className="darkcolor reddark" d="M40,0h670c22.1,0,40,17.9,40,40v391c0,22.1-17.9,40-40,40H40c-22.1,0-40-17.9-40-40V40
                            C0,17.9,17.9,0,40,0z" />
                                </g>
                            </g>
        ...
        <div className="form-container">
            <div className="field-container">
                ...
                <input id="name" maxLength="20" type="text" onChange={(e)=>{cardHolder(e.target.value)}}/>
            </div>
            <div className="field-container">
                <label htmlFor="cardnumber">Card Number</label>
                <input id="cardnumber" type="text" pattern="[0-9]*" inputMode="numeric" onInput={(e)=>{cardNum(e.target.value)}}/>
